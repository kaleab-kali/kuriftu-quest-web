    ...
    <>
      ...
      <div className="flex flex-wrap items-center gap-4 p-4">
        <div className="flex items-center space-x-2">
          <p className="text-sm font-medium">Challenge Type</p>
          <Select
            value={searchParams.get('challengeType') ?? 'all'}
            onValueChange={(value) => {
              const newParams = new URLSearchParams(searchParams);
              if (value === 'all') {
                newParams.delete('challengeType');
              } else {
                newParams.set('challengeType', value);
              }
        ...
        <div className="flex items-center space-x-2">
          ...
          <Select
            value={searchParams.get('rewardCategory') ?? 'all'}
            onValueChange={(value) => {
              const newParams = new URLSearchParams(searchParams);
              if (value === 'all') {
                newParams.delete('rewardCategory');
              } else {
                newParams.set('rewardCategory', value);
              }
              newParams.set('page', '1');
              setSearchParams(newParams);
            }}
      ...
      <ScrollArea className="h-[calc(80vh-220px)] rounded-md border md:h-[calc(75dvh-80px)]">
